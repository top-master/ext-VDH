...
(() => {
  weh.is_safe.then(() => {
    let t = createStore((e = {
      ...
      i = decodeURIComponent(new URL(document.URL)
        .hash.substr(1));
    weh.rpc.call("getHit", i)
      .then(e => {
        e ? t.dispatch({
          type: "setHit",
          payload: e
    ...
    class a extends React.Component {
      renderValue() {
        return this.props.name == "thumbnailUrl" || this.props.name ==
          ...
          React.createElement("div", null, React.createElement("em",
            null, "null")) : typeof this.props.value == "object" ?
