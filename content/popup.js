    ...
    var p = connect((n, t) => ({
      ...
      renderNoHit() {
        return this.state.section == "active" ? React.createElement(
            "div", {
              className: "no-media"
            }, React.createElement("h2", null, weh._(
              "no_media_current_tab")), React.createElement("p",
              null, weh._("no_media_to_process_descr"))) : React
          .createElement("div", {
            className: "no-media"
          }, React.createElement("h2", null, weh._(
            "no_media_to_process")))
      ...
      renderFooterButtons() {
        return React.createElement("div", {
          ...
          className: "separator"
        }, "\xA0"), this.canClear() && React.createElement(
          "button", {
      ...
      renderFooterGroups() {
        return React.createElement("div", {
            className: "groups"
          }, this.showGroupBadge("active", "in_current_tab"), this
          .showGroupText("active", "in_current_tab"), this
          .showGroupBadge("inactive", "in_other_tab"), this
          .showGroupText("inactive", "in_other_tab"), this
          .showGroupBadge("orphan", "orphan"), this.showGroupText(
            "orphan", "orphan"), this.showGroupBadge("pinned",
            "pinned"), this.showGroupText("pinned", "pinned"),
          this.showGroupBadge("running", "running"), this
          .showGroupText("running", "running"), this
          .showGroupBadge("log", "logs"), this.showGroupText(
            "log", "logs"))
      }
      renderFooter() {
        return React.createElement("footer", null, React
          .createElement("div", {
      ...
      render() {
        return React.createElement("div", {
            className: "main-panel " + ((this.state.actionHit ||
              this.props.embed) && "actions-open " || " ")
          }, this.renderActions(), this.renderEmbed(), React
          .createElement("div", {
              className: "main-content section-" + this.state
                .section,
              style: {
