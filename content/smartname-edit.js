...
(() => {
  weh.is_safe.then(() => {
    ...
    function loadRules() {
      return weh.rpc.call('getSmartNameRules').then(rules => {
      ...
      class extends React.Component {
        ...
        removeRule(ruleKey) {
          ...
          return event => {
            ...
            weh.rpc
              .call('removeFromSmartName', [ruleKey])
              .then(() => loadRules());
          };
        }
        editRule(ruleKey) {
          ...
          var ruleElements = Object.keys(this.props.rules)
            ...
            .map(ruleKey =>
              React.createElement(
                ...
                React.createElement('div', null, ruleKey),
                React.createElement(
                  'div',
                  {
                    className: 'delete',
        ...
        saveRule() {
          var self = this;
          return () => {
            weh.rpc.call('addSmartNameRule', self.state.rule).then(() => {
              loadRules();
            });
            self.setState({
              rule: null,
          ...
          return event => {
            ...
            switch (field) {
              ...
              case 'regexp':
                ...
                break;
              case 'domain':
                update.rule.domain = value;
                if (/^\S+\.\S+$/.test(value)) {
                  update.domainClass = '';
                } else {
                  update.domainClass = 'error';
                }
                break;
              case 'delay':
                update.rule.delay = value;
                if (/^[0-9]+$/.test(value)) {
                  update.delayClass = '';
                } else {
            ...
            update.rule = Object.assign({}, self.state.rule, update.rule);
            self.setState(Object.assign({}, self.state, update));
          };
        }
        renderRule() {
          return React.createElement(
                ...
                React.createElement(
                  ...
                  React.createElement(
                    ...
                    React.createElement(
                      ...
                      weh._(
                        (this.state.newRule && 'smartname_create_rule')
    ...
    render(
      React.createElement(
        ...
        React.createElement(SmartNameEditor, null),
      ),
