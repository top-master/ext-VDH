  ...
  weh.is_safe.then(async () => {
    ...
    let ConnectedDownloadConvertEmbed = connect(
      ...
      storeState => ({
        ...
        showSaveAs:
          new URL(window.location.href).searchParams.get('nosaveas') != '1',
      }),
    )(
      class DownloadConvertEmbed extends React.Component {
        ...
        createConfigureHandler() {
          return () => {
            weh.rpc
              .call('editConverterConfigs', this.state.outputConfig)
              .then(() => {
                if (this.props.closeWindow) {
                  this.props.closeWindow();
                }
        ...
        componentWillMount() {
          const hitId = decodeURIComponent(
                ...
                React.createElement(
                  ...
                  React.createElement(
                    ...
                    React.createElement(
                      'h3',
                      null,
                      weh._('dlconv_download_and_convert'),
                    ),
                    this.state.hit
                      && React.createElement('p', null, this.state.hit.title),
                  ),
                  React.createElement(
                    'div',
                    null,
