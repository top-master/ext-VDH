...
(() => {
  weh.is_safe.then(async () => {
    let o = await weh.prefs,
      n = createStore(combineReducers({
        prefs: o.reducer
      }));
    o.reduxDispatch(n);
    let ConnectedDownloadConvertEmbed = connect(t => ({
      ...
      createSaveHandler(t) {
        ...
        return () => {
          weh.trigger({
              ...
              outputConfig: e.state.outputConfigs[e.state
                .outputConfig],
              prompt: t
            })
            .then(() => {
      ...
      componentWillMount() {
        var t = this,
          e = decodeURIComponent(new URL(document.URL)
            .hash.substr(1));
        weh.rpc.call("getHit", e)
          .then(s => {
            t.setState({
              hit: s
            })
      ...
      componentWillReceiveProps(t) {
        this.setState({
          outputConfig: t.prefs.dlconvLastOutput
        })
      }
      render() {
        var t = this,
          e;
        this.state.outputConfig ? e = this.state.outputConfigs :
          e = Object.assign({}, this.state.outputConfigs, {
            "": {
        ...
        return React.createElement("div", {
          ...
          .createElement("main", null, React.createElement(
            "div", {
              className: "dlconv"
            }, React.createElement("div", {
                className: "explain"
              }, React.createElement("h3", null, weh._(
                "dlconv_download_and_convert")), this.state
              .hit && React.createElement("p", null, this
