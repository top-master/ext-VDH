          ...
          !/^[A-Z]:\\$/.test(this.state.directory) && e.unshift(
            ...
            .createElement("div", {
              ...
              .editFileInput && React.createElement("input", {
                ...
                className: "form-control",
                type: "text"
              }), this.state.directory !== null && this.props
              .readonlyDir && React.createElement("div", {
                className: "form-control dir-path",
                title: this.state.directory
              }, this.state.directory), this.props.newDir &&
              this.state.dirExits && React.createElement(
                "button", {
                  className: "btn btn-outline-secondary",
                  title: weh._("new_sub_directory"),
                  onClick: this.newSubDirectory()
                }, "\u271A")), this.props.showDir && React
            .createElement("div", {
              className: "current-directory"
            }, this.state.directory || ""), React.createElement(
              "div", {
                className: "files-list headercontainer"
              }, React.createElement("div", {
                className: "tablecontainer"
              }, React.createElement("table", null, React
                .createElement("thead", null, React
                  .createElement("tr", null, React
                    .createElement("th", null, this.props
                      .selectMultiple && React.createElement(
                      ...
                      .showSort("name"), " ", weh._(
                        "file_dialog_name"))), !this.props
                    .noSizeColumn && React.createElement(
                    "th", {
                      onClick: this.setSort("size")
                    }, React.createElement("div", null, this
                      .showSort("size"), " ", weh._(
                        "file_dialog_size"))), React
                    .createElement("th", {
            ...
            .outputConfigs && React.createElement("div", {
              ...
              cancel: this.cancel()
                .bind(this)
            }))), React.createElement("footer", null, React
            .createElement("div", {
            ...
            }, this.props.okText || "")))), React.createElement(
            VDHModal, {
    ...
    class n extends React.Component {
      ...
      render() {
        ...
        return React.createElement("div", {
          ...
          "output_configuration")), React.createElement(
        "select", {
          className: "form-control",
