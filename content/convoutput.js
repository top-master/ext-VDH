      ...
      render() {
        ...
        return React.createElement("div", {
            ...
            .createElement("div", {
              ...
              readOnly: this.state.config && this.state
                .config.readonly,
              value: this.state.config && this.state.config
                .title || "",
              className: "form-control"
            })), React.createElement("div", {
              ...
              .createElement(Button, {
                ...
                type: "button",
                color: "secondary"
              }, weh._("convconf_duplicate")), React
              .createElement(ButtonDropdown, {
                ...
                }, weh._("convconf_new")), React
                .createElement(DropdownItem, {
                  divider: !0
                }), React.createElement(DropdownItem, {
                  onClick: this.local("remove"),
                  disabled: this.state.config.readonly
                }, weh._("convconf_remove")), React
                .createElement(DropdownItem, {
                  disabled: !this.canReset(),
                  onClick: this.local("reset")
                }, weh._("convconf_reset")))))), this.state
          .config && this.state.config.readonly && React
          .createElement("div", {
            className: "notice"
          }, weh._("convconf_readonly")), React.createElement(
            "div", {
              className: "params"
              ...
              .createElement(NavLink, {
                className: this.state.activeTab ===
                  "general" ? "active" : "",
                onClick: this.local("setActiveTab",
                  "general")
              }, weh._("general"))), React.createElement(
              NavItem, null, React.createElement(NavLink, {
                className: this.state.activeTab ===
                  "advanced" ? "active" : "",
                onClick: this.local("setActiveTab",
                  "advanced")
              }, weh._("advanced")))), React.createElement(
              TabContent, {
                activeTab: this.state.activeTab
              }, React.createElement(TabPane, {
                tabId: "general"
              }, this.renderParameterList("general")), React
              .createElement(TabPane, {
                tabId: "advanced"
              }, this.renderParameterList("advanced")))), React
          .createElement(Modal, {
            ...
            toggle: this.local("toggleResetConfirm")
          }), React.createElement(ModalBody, null, weh._(
            "convconf_reset_confirm")), React.createElement(
            ModalFooter, null, React.createElement(Button, {
              color: "secondary",
      ...
      getParameters() {
        ...
        return e.forEach(l => {
          ...
          advanced: [{
            ...
            type: "select",
            paramValue: "preset",
            options: ["ultrafast", "superfast", "veryfast",
