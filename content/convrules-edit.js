...
(() => {
  ...
  var toEsm = (moduleRef, isNodeMode, esmTarget) => (
    (esmTarget =
      moduleRef != null ? objectCreate(getPrototypeOf(moduleRef)) : {}),
    copyProps(
      isNodeMode || !moduleRef || !moduleRef.__esModule
  ...
  weh.is_safe.then(() => {
    ...
    function loadRulesFn() {
      return weh.rpc.call('getConversionRules').then(loadedRulesData => {
    ...
    function saveRulesFn() {
      return weh.rpc.call('getOutputConfigs').then(savedRulesResult => {
        window.store.dispatch({
    ...
    saveRulesFn();
    var ConnectedRulesEditor = connect(
      (mapStateToPropsState, mapStateToPropsOwnProps) => ({
      ...
      class extends React.Component {
        ...
        cancel() {
          ...
          return () => {
            ...
            if (!editorSelf2.state.rule) {
              newRuleTemplate.rules = editorSelf2.props.rules.slice(0);
            }
            editorSelf2.setState(newRuleTemplate);
          };
        }
        removeRule(removeRuleId) {
          var editorSelf3 = this;
          return removeRuleEvent => {
            removeRuleEvent.stopPropagation();
            editorSelf3.state.rules.every((ruleEntry, ruleEntryIndex) => {
              if (ruleEntry.id === removeRuleId) {
                var rulesCopy = editorSelf3.state.rules.slice(0);
                rulesCopy.splice(ruleEntryIndex, 1);
                editorSelf3.setState({
                  rules: rulesCopy,
                });
                return !1;
              }
        ...
        editRule(editRuleId) {
          ...
          return () => {
            editorSelf4.state.rules.every(editRuleEntry =>
              editRuleEntry.id === editRuleId
                ? (editorSelf4.setState({
        ...
        renderAll() {
          ...
          let SortableRuleElement = (0, sortableHoc.SortableElement)(
            sortableElementRenderProps => {
              var sortableElementValue = sortableElementRenderProps.value;
              var ruleChildren = [];
              if (sortableElementValue.convert) {
                ruleChildren.push(weh._('convrule_convert'));
              } else {
                ruleChildren.push(weh._('convrule_no_convert'));
              }
              if (sortableElementValue.domain) {
                ruleChildren.push(
                  weh._('convrule_from_domain', [sortableElementValue.domain]),
                );
              }
              if (sortableElementValue.extension) {
                ruleChildren.push(
                  weh._('convrule_with_ext', [sortableElementValue.extension]),
                );
              }
              ruleChildren.push(
                weh._('convrule_format', [
                  (editorSelf5.props.formats[sortableElementValue.format]
                    && editorSelf5.props.formats[sortableElementValue.format]
                      .title)
                    || '????',
                ]),
          ...
          let SortableRulesContainer = (0, sortableHoc.SortableContainer)(
            ({ items: sortableContainerItems }) =>
              React.createElement(
                ...
                sortableContainerItems.map(
                  (containerItem, containerItemIndex) =>
                    React.createElement(SortableRuleElement, {
            ...
            React.createElement(
              ...
              (this.state.rules || []).length == 0
                && React.createElement(
                  ...
                  weh._('convrules_empty'),
                ),
              (this.state.rules || []).length > 0
                && React.createElement(SortableRulesContainer, {
            ...
            if (
              editorSelf6.state.rules.every((ruleIterEntry, ruleIterIndex) => {
                if (ruleIterEntry.id === editorSelf6.state.rule.id) {
                  ...
                  rulesCopy2[ruleIterIndex] = editorSelf6.state.rule;
        ...
        saveRules() {
          ...
          return () => {
            weh.rpc
              .call('setConversionRules', editorSelf7.state.rules)
              .then(() => {
                loadRulesFn();
              });
          };
        ...
        onChange(onChangeRuleId) {
          ...
          return onChangeEvent => {
            var onChangeParsed;
            if (onChangeEvent.target.getAttribute('type') == 'checkbox') {
              onChangeParsed = onChangeEvent.target.checked;
            } else {
              onChangeParsed = onChangeEvent.target.value;
            }
            var onChangeUpdate = {
              rule: {},
            };
            ...
            onChangeUpdate.rule = Object.assign(
              {},
              editorSelf8.state.rule,
              onChangeUpdate.rule,
            );
            editorSelf8.setState(
              Object.assign({}, editorSelf8.state, onChangeUpdate),
            );
          };
        }
        renderRule() {
          var editorSelf9 = this;
          var sortedFormatKeys = Object.keys(this.props.formats)
            .sort(
              (formatSortA, formatSortB) => (
                (formatSortA = editorSelf9.props.formats[formatSortA]),
                (formatSortB = editorSelf9.props.formats[formatSortB]),
                formatSortA.title < formatSortB.title
                  ? -1
                  : formatSortA.title > formatSortB.title
                    ? 1
                    : 0
          ...
          return React.createElement(
            ...
            React.createElement(
              ...
              React.createElement(
                ...
                React.createElement(
                  'select',
                  {
                    ...
                    value:
                      (this.state.rule.convert && 'convert') || 'noconvert',
                  },
                  React.createElement(
                    'option',
                    {
              ...
              React.createElement(
                ...
                this.state.rule.extension !== null
                  && React.createElement('input', {
                    className: 'form-control col-sm-7',
        ...
        render() {
          return React.createElement(
            ...
            React.createElement(
              'main',
              null,
              (this.state.rule && this.renderRule()) || this.renderAll(),
            ),
            React.createElement(
              'footer',
              null,
                ...
                React.createElement(
                  ...
                  this.state.rule
                    && React.createElement(
                      ...
                      weh._(
                        (this.state.newRule && 'conversion_create_rule')
    ...
    render(
      React.createElement(
        ...
        React.createElement(ConnectedRulesEditor, null),
      ),
