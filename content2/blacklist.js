...
var NoneImpl = (function () {
  ...
  NoneConstructor.prototype.isSome = function () {
    return !1;
  };
...
var SomeImpl = (function () {
  ...
  SomeConstructor.EMPTY = new SomeConstructor(void 0);
...
(function (optionNamespace) {
  function allSome() {
    ...
    for (
      var values = [], collectIndex = 0, optionList = options;
      collectIndex < optionList.length;
      collectIndex++
    ) {
  ...
  function firstSome() {
    ...
    for (
      var scanIndex = 0, optionList = options;
...
var ErrImpl = (function () {
  function ErrConstructor(error) {
    if (!(this instanceof ErrConstructor)) {
      return new ErrConstructor(error);
    }
    this.error = error;
...
`);
  ...
  ErrConstructor.prototype.isOk = function () {
    return !1;
  };
...
`,
  ...
  ErrConstructor.EMPTY = new ErrConstructor(void 0);
  return ErrConstructor;
})();
var errConstructor = ErrImpl;
var OkImpl = (function () {
  function OkConstructor(value) {
    if (!(this instanceof OkConstructor)) {
      return new OkConstructor(value);
    }
    this.value = value;
  }
  OkConstructor.prototype.isOk = function () {
    return !0;
  };
  ...
  OkConstructor.EMPTY = new OkConstructor(void 0);
  return OkConstructor;
})();
...
(function (resultNamespace) {
  function allOk() {
    ...
    for (
      var values = [], collectIndex = 0, resultList = results;
      collectIndex < resultList.length;
      collectIndex++
    ) {
  ...
  function firstOk() {
    ...
    for (
      var errors = [], collectIndex = 0, resultList = results;
      collectIndex < resultList.length;
      collectIndex++
    ) {
      var result = resultList[collectIndex];
  ...
  function isResult(candidate) {
    return (
      candidate instanceof errConstructor || candidate instanceof okConstructor
    );
  }
...
var generatorHelper = function (thisArg, body) {
  ...
  function step(currentOp) {
    ...
    for (; iterator && ((iterator = 0), currentOp[0] && (state = 0)), state; ) {
      try {
        if (
          ((executing = 1),
          currentIterator
              ...
              currentOp[0] & 2
                ...
                : currentOp[0]
                  ? currentIterator.throw
                    || ((currentOperation = currentIterator.return)
                      && currentOperation.call(currentIterator),
                    0)
                  : currentIterator.next)
            && !(currentOperation = currentOperation.call(
              currentIterator,
              currentOp[1],
            )).done)
        ) {
        ...
        switch (
          ((currentIterator = 0),
          currentOperation
            && (currentOp = [currentOp[0] & 2, currentOperation.value]),
          currentOp[0])
        ) {
          case 0:
          case 1:
          ...
          case 5:
            state.label++;
            currentIterator = currentOp[1];
            currentOp = [0];
            continue;
          case 7:
            currentOp = state.ops.pop();
            state.trys.pop();
            continue;
          default:
            if (
              ((currentOperation = state.trys),
              !(currentOperation =
                currentOperation.length > 0
                && currentOperation[currentOperation.length - 1])
                && (currentOp[0] === 6 || currentOp[0] === 2))
            ) {
              state = 0;
              continue;
            }
            if (
              currentOp[0] === 3
              && (!currentOperation
                || (currentOp[1] > currentOperation[0]
                  && currentOp[1] < currentOperation[3]))
            ) {
              state.label = currentOp[1];
              break;
            }
            if (currentOp[0] === 6 && state.label < currentOperation[1]) {
              state.label = currentOperation[1];
              currentOperation = currentOp;
              break;
            }
            if (currentOperation && state.label < currentOperation[2]) {
              state.label = currentOperation[2];
              state.ops.push(currentOp);
              break;
            }
...
var AsyncResult = (function () {
  ...
  AsyncResultConstructor.prototype.andThen = function (thenFn) {
    var self = this;
      ...
      return awaiter(self, void 0, void 0, function () {
        ...
        return generatorHelper(this, function (genContext) {
          if (prevResult.isErr()) {
            ...
            nextResult = thenFn(prevResult.value);
            return [
              2,
              nextResult instanceof AsyncResultConstructor
                ? nextResult.promise
                : nextResult,
            ];
          }
          ...
          switch (genContext.label) {
            case 0:
              if (prevResult.isErr()) {
                ...
                okCtorRef = okConstructor;
                return [4, mapFn(prevResult.value)];
              }
            case 1:
