...
(() => {
  ...
  var Gu = v((Ux, Xu) => {
    ...
    Xu.exports = [{
      ...
      type: "choice",
      defaultValue: "tasks",
      choices: ["none", "tasks", "activetab", "anytab", "pinned",
        "mixed"
      ]
    }, {
      name: "hitsGotoTab",
      ...
      type: "choice",
      choices: ["page_android_ios_tvep", "page_ios_android_tvep",
        "android_ios_tvep_page", "ios_android_tvep_page",
        "page_tvep_android_ios", "android_ios_tvep", "page",
        "android", "tvep", "ios"
      ],
...
`) + 1) : ""
  ...
  function Zf() {
    de == "mozilla" ? (dt.default.browserAction.setPopup({
      ...
      popup: "/content/popup.html?panel=main"
    }), chrome.sidePanel && chrome.sidePanel.setPanelBehavior && (chrome
            ...
            ({
              tag() {
                ({
                  ...
                  inf() {
                    "mediaSequence" in this.manifest || (this
                        .manifest.mediaSequence = 0, this
                        .trigger("info", {
